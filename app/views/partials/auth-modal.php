...
<div id="authModal" class="hidden fixed inset-0 bg-black/40 backdrop-blur-sm z-[9999] items-center justify-center">
  <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 relative">
    ...
    <!-- Nút đóng -->
    <button id="closeModal" class="absolute top-3 right-3 text-gray-500 hover:text-gray-800 text-xl font-bold">✕</button>

    <!-- Tabs -->
    <div class="flex justify-center mb-5 border-b border-gray-200">
      <button id="loginTab" class="flex-1 py-2 font-semibold text-yellow-600 border-b-2 border-yellow-500">Đăng nhập</button>
      <button id="registerTab" class="flex-1 py-2 font-semibold text-gray-500 hover:text-yellow-600">Đăng ký</button>
    </div>
